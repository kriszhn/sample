...
int main(void)
{
  ...
  osThreadDef(red, StartTask01, osPriorityNormal, 0, 128);
  redHandle = osThreadCreate(osThread(red), NULL);

  /* definition and creation of green */
  osThreadDef(green, StartTask02, osPriorityNormal, 0, 128);
  greenHandle = osThreadCreate(osThread(green), NULL);

  /* definition and creation of blue */
  osThreadDef(blue, StartTask03, osPriorityNormal, 0, 128);
